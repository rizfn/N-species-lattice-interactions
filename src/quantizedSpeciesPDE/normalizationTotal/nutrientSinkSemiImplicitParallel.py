...
def main():
    ...
    output_dir = f"src/quantizedSpeciesPDE/plots/nutrientSink1D/parameter_sweep_semiimplicit"
    ...
    ax1.set_title('Number of Majority Species Switches Across Space')
    ...
    ax2.set_title('Average Concentration of Majority Species')
